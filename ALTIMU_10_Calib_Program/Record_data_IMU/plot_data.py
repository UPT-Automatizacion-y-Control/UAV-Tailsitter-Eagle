...
A = np.array([[1.011345, 0.000813, -0.003962],  # 'A^-1' matrix from Magneto
              [0.000813, 1.009316, 0.001345],
              [-0.003962, 0.001345, 0.997126]])
# 'Combined bias (b)' vector from Magneto
b = np.array([0.014119, 0.012026, 0.021333])

# Read raw data and apply calibration
rawData = np.genfromtxt('raw_data_3.txt',
